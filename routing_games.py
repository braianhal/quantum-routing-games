...
class RoutingGame:
    ...
    def __init__(self, N, packets_to_send, protocol=None, rounds=1):
        self.N = N
    ...
    def play(self):
        ...
        # C. Ejecución de las rondas (actualiza red y métricas).
        metrics = []
    ...
    def _play_round(self):
        # 1. Cálculo de caminos efectivamente elegidos.
        selected_paths = self.protocol.select_paths(self.N, self.packets, self.possible_paths)

        # 2. Actualización del flujo de la red y latencia de paquetes.
